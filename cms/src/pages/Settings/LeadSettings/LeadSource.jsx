...
const LeadSource = () => {
  ...
  const handleSave = () => {
    ...
    setLeadSources([...leadSources, selectedSource]);
    setSelectedSource('');
  };
  ...
  const handleUpdate = (index) => {
    if (!editingValue.trim()) {
      alert('Lead Source cannot be empty!');
      return;
    }
    const updatedSources = [...leadSources];
    updatedSources[index] = editingValue;
  ...
  const handleRemove = (index) => {
    if (window.confirm('Are you sure you want to remove this Lead Source?')) {
