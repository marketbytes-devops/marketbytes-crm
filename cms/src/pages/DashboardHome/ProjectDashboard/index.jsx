...
import { FolderOpenDot, Clock, CheckCircle, AlertCircle, CalendarSearch, ArrowUpAZ, PieChart } from 'lucide-react';
...
const ProjectDashboard = () => {
  ...
  const visibleWidgets = {
    ...
    projectStatusDiagram: widgetSettings?.projectStatusDiagram ?? true,
    projectsNearingDeadline: widgetSettings?.projectsNearingDeadline ?? true,
  };
  ...
  return (
    <div>
            ...
            <div className="space-y-2 w-[250px]">
              {sortOptions.map((option) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-2 text-sm rounded-lg ${sortOption === option.value
                      ? 'bg-black text-white'
      ...
      <div className="rounded-3xl bg-gray-50 border border-gray-200 mb-4 w-full h-auto p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4">
        {visibleWidgets.projectStatusDiagram && (
          <div className="bg-white shadow-md rounded-3xl p-6">
            <div className="flex items-center space-x-2 mb-4">
              <PieChart className="w-5 h-5 text-gray-600" />
              <h2 className="text-black text-md font-semibold">Project Status Diagram</h2>
            </div>
            <div className="h-64">
        ...
        {visibleWidgets.projectsNearingDeadline && (
          <div className="bg-white shadow-md rounded-3xl p-6">
                    ...
                    paginatedProjects.map((project, index) => (
                      <tr key={project.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="p-3 text-xs">
                          <span
                            className={`w-3.5 rounded-full text-xs px-2 py-1 ${project.status === 'Overdue'
